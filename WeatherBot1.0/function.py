...
def get_weather(region):
    ...
    return url, today, today_sunrise, today_sunset, today_maximum, today_least, today_morning, today_afternoon, today_weather_img,tomorrow, tomorrow_sunrise, tomorrow_sunset, tomorrow_maximum, tomorrow_least, tomorrow_morning, tomorrow_afternoon, tomorrow_weather_img,tomorrow_comment
